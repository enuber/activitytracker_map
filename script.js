...
class App {
  ...
  _getPosition() {
    if (navigator.geolocation) {
      //by binding this it points to the correct object. And binds return a new function. So this fixes the issue of what this is
  ...
  _loadMap(position) {
    ...
    //using leaflet to creat the map
  ...
  _newWorkout(e) {
    //by using spread operater we get an array, also remember that every checks to see if all are true
